...
-> ## Modes — /commander, /execute, /advisor Part intentionally removed by human, already have gstack-pilot plugin for that.
...
this — routing pure bookkeeping through a PR would be over-engineering
for zero safety gain on content with no code/workflow risk.
