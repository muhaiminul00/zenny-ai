...
### Zenny Runtime - Sheets KB Ingestion (BC-076-Card2b)
**n8n ID:** `KR0kHvk3kJRThrX5` · **published**, active (2026-09-01, `activeVersionId 0513539e-...`) — Credential Gate cleared, live-verified end to end
...
**3 REAL BUGS FOUND AND FIXED, live execution (not caught by `validate_workflow` — none of these are structural/type errors, only surface at runtime against real data):**
